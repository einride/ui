...
import { DEFAULT_MAX, DEFAULT_MIN, LinearGauge } from "./LinearGauge"
...
/** If you have a custom value range, you can set that with the `min` and `max` props, and `value` will take those into account. In this example, `value: 110` is 75% of the range between 80 and 110, which is also conveyed by the gauge.  */
...
/** Change the color of the gauge with the `color` prop. */
