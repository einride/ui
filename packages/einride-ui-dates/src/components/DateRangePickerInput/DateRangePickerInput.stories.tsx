...
} satisfies Meta<typeof DateRangePickerInput>
...
const ControlledTemplate = (
  args: ComponentProps<typeof DateRangePickerInput>,
): React.JSX.Element => {
  const [value, setValue] = useState<DateRangePickerValue>([null, null])
  return <DateRangePickerInput {...args} value={value} onChange={setValue} />
}
