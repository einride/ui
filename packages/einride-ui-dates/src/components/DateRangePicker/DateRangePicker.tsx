...
export const DateRangePicker = ({ wrapperProps, ...props }: DateRangePicker): React.JSX.Element => {
  const theme = useTheme()

  const datePickerProps: DayPickerRangeProps = {
    mode: "range",
    ...props,
  }

  if (props.selected?.from) {
    datePickerProps.defaultMonth = props.selected.from
  }
